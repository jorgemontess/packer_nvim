...
_G.packer_plugins = {
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/jorge/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["transparent.nvim"] = {
    loaded = true,
    path = "/home/jorge/.local/share/nvim/site/pack/packer/start/transparent.nvim",
  ...
  ["zephyr-nvim"] = {
    loaded = true,
    path = "/home/jorge/.local/share/nvim/site/pack/packer/start/zephyr-nvim",
